...
export default {
  ...
  number: /^[0-9]*$/,
  // 姓名
  username: /^[a-zA-Z]\w{3,20}$/,
  // 用户管理 用户名称
  userName: /^[a-zA-Z0-9_\\.]{3,14}$/,
  // 真实姓名
  realName: /^[a-zA-Z0-9_\\.\u4E00-\u9FA5]{1,30}$/,
  // 传真号码
  fax: /^(\d{3,4})?[-]?\d{7,8}$/,
  // 仅英文或者数字
  charOrNum: /^([a-zA-Z0-9]+)$/,
  ...
  zipCode: /^[0-9]\d{5}(?!\d)$/,
  // 座机或者手机（座机号包括地区号）
  phoneOrMoblie: /(^((0\d{2,3})-?)(\d{7,8})(-?(\d{0,3}))?$)|(^1(3|4|5|7|8)[0-9]{9}$)/,
  // 座机
  ...
  // 系统设置里的ip
  _ip: /^(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){3}$/,
  // 邮箱验证
  ...
  // 用户管理 8-20位字符 数字/字母(大小写)/特殊字符都至少存在一个
